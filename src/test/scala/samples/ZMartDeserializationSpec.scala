...
class ZMartDeserializationSpec extends AnyWordSpec {
  val purchase = Purchase("0000_0000_0000_0000_1234", "customer1", Map(Item("item_id_1", 50.23) -> 2), "50202", "Cafe")
  ...
  "purchaseSerde" should {
    ...
    "deserialize purchase" in {
      val raw = "{\"creditCard\":\"0000_0000_0000_0000_1234\",\"customerId\":\"customer1\",\"itemQty\":[{\"item\":{\"id\":\"item_id_1\",\"price\":50.23},\"qty\":2}],\"zipCode\":\"50202\",\"department\":\"Cafe\"}"
